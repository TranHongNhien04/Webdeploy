        ...
        <footer className="bg-white text-black py-6 border-t">
            <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                ...
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-12">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="#" className="text-gray-600 text-sm hover:text-blue-500">Facebook</a>
                            <a href="#" className="text-gray-600 text-sm hover:text-blue-500">Instagram</a>
                            <a href="#" className="text-gray-600 text-sm hover:text-blue-500">Twitter</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full md:w-auto">
                    ...
                    <p className="text-gray-600 text-sm mb-2">Để nhận thông báo sản phẩm và thông tin độc quyền</p>
            ...
            <div className="container mx-auto px-6 mt-6 flex flex-col md:flex-row justify-between items-center border-t pt-4">
                <div className="flex items-center space-x-4">
                    ...
                    <p className="text-gray-600 text-sm">
                        © 2025 Fruvia Beauty, Inc. · <a href="#" className="hover:text-blue-500">Quyền riêng tư</a> · <a href="#" className="hover:text-blue-500">Điều khoản</a> · <a href="#" className="hover:text-blue-500">Sơ đồ trang</a>
                    </p>
                </div>
